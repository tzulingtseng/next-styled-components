...
var MenuWithChild = function MenuWithChild(_ref5) {
  ...
  return __jsx(_react.Fragment, null, __jsx(MenuItem, {
    hasChild: true,
    open: open,
    text: item.text,
    icon: item.icon,
    onClick: handleOnClick
  }), __jsx(_Collapse["default"], {
    open: open
  }, __jsx(MenuItems, {
    items: item.children
  })));
...
var MenuItems = function MenuItems(_ref7) {
  ...
  return items.map(function (item, index) {
    var hasChild = !(0, _isEmpty["default"])(item.children) && item.children.length > 0;
    return hasChild ? __jsx(MenuWithChild, {
