...
var _excluded = ["alertDialogOpen", "children", "title", "onCancel", "onConfirm", "confirmText", "cancelText", "type"];
...
var Alert = function Alert(_ref2) {
  ...
  return __jsx(_Mask["default"], null, __jsx(StyledDialog, null, __jsx(_Card["default"], {
    ...
    onClick: onCancel
  })), __jsx(_CardBody["default"], null, __jsx(StyledIcon, {
    type: type,
    icon: ICON_MAP[type]
  }), children), __jsx(_CardFooter["default"], {
    style: footerStyle
