...
var _excluded = ["items", "label", "required", "onChange", "placeholder", "errorMessage"];
...
var StyledTypography = (0, _styledComponents["default"])(_Typography["default"]).withConfig({
...
var SelectTest = function SelectTest(_ref17) {
  ...
  return __jsx(_react.Fragment, null, __jsx(_FormGroup["default"], null, __jsx(_FormLabel["default"], {
    ...
    open: open,
    errorMessage: errorMessage
  }, __jsx(StyledTypography, null, selectedItem.label || placeholder), __jsx(StyledIcon, {
    icon: "fa-angle-down",
    size: 12
  }), __jsx(StyledInput, {
    type: "text",
    ...
    open: open,
    anchorEl: menuEle
  }, __jsx(OptionBox, null, items && items.map(function (item, index) {
    var key = "select_item_".concat(item.label, "_").concat(item.vale, "_").concat(index);
    return __jsx(Options, {
      key: key,
...
var handleOnChange = function handleOnChange(values, setValue) {
  return function (_ref18) {
    ...
    var newValues = values.includes(value) ? values.filter(function (selectedValue) {
...
var Select = function Select(_ref19) {
  ...
  return __jsx(SelectTest, (0, _extends2["default"])({}, props, {
    values: values,
    onChange: onChange
  }));
};
