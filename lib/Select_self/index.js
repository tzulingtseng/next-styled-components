...
var StyledSelect = (0, _styledComponents['default'])('div').withConfig({
    ...
    return {
        ...
        height: 40,
        border: optionActive
            ? '1px solid '.concat(theme.colors.primary)
            : '1px solid '.concat(theme.colors.grey2),
...
var Select_self = function Select_self(_ref6) {
    var selectItems = _ref6.selectItems,
        ...
        placeholder =
            _ref6$placeholder === void 0 ? '請選擇...' : _ref6$placeholder,
    ...
    return __jsx(
        ...
        __jsx(
            ...
            __jsx(
                ...
                __jsx('div', null, selectedItem.label || placeholder),
                __jsx(_Icon['default'], {
                    icon: 'fa-angle-down',
                    size: 12,
                })
