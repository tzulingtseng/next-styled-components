...
var StyledStep = (0, _styledComponents["default"])('span').withConfig({
  ...
  return {
    ...
    backgroundColor: active.includes(step) ? theme.colors.primary : theme.colors.grey1
  };
});
...
var Steps = function Steps(_ref3) {
  var steps = _ref3.steps,
    active = _ref3.active;
  return __jsx(StyledStepsContainer, null, steps.map(function (item, i) {
    return __jsx(_react.Fragment, {
      key: i
    }, __jsx(StyledStep, {
      active: active,
      step: item
    }, item), i !== steps.length - 1 && __jsx(StyledSeparate, null));
  }));
};
var _default = Steps;
