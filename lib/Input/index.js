...
var _excluded = ["label", "errorMessage", "value", "required", "onChange", "placeholder"];
...
var StyledInput = (0, _styledComponents["default"])('input').withConfig({
  ...
  return {
    ...
    border: "1px solid ".concat((0, _isEmpty["default"])(errorMessage) ? theme.colors.grey1 : theme.colors.danger),
    "&:active, &:focus": {
...
var Input = function Input(_ref2) {
  ...
  return __jsx(_react.Fragment, null, __jsx(_FormGroup["default"], null, __jsx(_FormLabel["default"], {
    required: required
  }, label), __jsx(StyledInput, (0, _extends2["default"])({
    value: value,
    onChange: onChange,
    errorMessage: errorMessage,
    placeholder: placeholder
  }, props))), __jsx(_ErrorMessage["default"], {
    errorMessage: errorMessage
  }, errorMessage));
};
var _default = Input;
