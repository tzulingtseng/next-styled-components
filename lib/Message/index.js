...
var StyledMessageContainer = (0, _styledComponents["default"])('div').withConfig({
...
var Message = function Message(_ref3) {
  ...
  return __jsx(StyledMessageContainer, null, __jsx(StyledMessage, (0, _extends2["default"])({}, props, {
    active: open
  }), __jsx(StyledIcon, {
    type: type,
    icon: ICON_MAP[type]
